...
class AppConfigHelper extends \PHPUnit\Framework\Assert {
	 ...
	 * @throws Exception
	 */
	public static function getOCSResponse(?ResponseInterface $response):string {
	 ...
	 * @throws Exception
	 */
	public static function getCapabilitiesXml(?ResponseInterface $response):string {
